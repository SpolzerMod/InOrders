...
public final class Icons {
	...
	public static ItemStack describe(ItemStack source, int amount, List<Component> lines) {
	...
	public static ItemStack named(ItemStack source, Component name, List<Component> lore) {
		ItemStack item = source.clone();
		ItemMeta meta = item.getItemMeta();
		meta.displayName(name);
		meta.lore(lore);
